 ...
 * 2018-Jul-18 kenw   Disable console output in demo of call
 *                      to br_QueryOneTestCase().
...
char myOrder[BUFLEN];
     ...
     *
     * Normally, br_QueryOneTestCase would be executed without
     * expecting console output. To disable diagnostic console output entirely,
     * first set all trace flags off.
     */
