...
This project uses Cmake FetchContent in manifest mode. Please keep this in mind when giving FetchContent suggestions. Do not provide suggestions like FetchContent install library, as they will not work as expected.
